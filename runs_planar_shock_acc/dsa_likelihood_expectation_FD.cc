...
// Set coefficients (and print to file) and initial condition
   coeffs.open("dsa_results/likelihood_coeffs_FD_serial.dat");
...
// Iterate
   solution.open("dsa_results/likelihood_solution_FD_serial.dat");
...
// Update time
   ...
   if (problem) std::cerr << "PROBLEM: solution became negative!" << std::endl;
   else {
...
// Print parameters to file
   params.open("dsa_results/likelihood_params_FD_serial.dat");
